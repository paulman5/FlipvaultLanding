  ...
  return (
    <header className="w-full pt-12 pb-8 flex flex-col items-center relative z-[1] animate-slide-down-fade">
      ...
      <div
        ...
        className={`mt-2 mb-3 text-xl md:text-2xl font-bold text-white text-center w-fit px-3 max-w-[90%] mx-auto relative ${
          isTypingComplete ? "after:animate-blink" : ""
        }`}
        style={{
      ...
      >
        <span>{typedText}</span>
        {isTypingComplete && (
          <span className="border-r-2 border-[#0032cc] ml-1 h-[1.2em] inline-block animate-cursor-blink"></span>
        )}
      </div>
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-4 animate-pop-in">
        <Button
          ...
          onClick={() =>
            (window.location.href = "https://app.flipvault.io/nft-marketplace")
          }
        >
          Enter the Vault
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://flipvault.gitbook.io/flipvault?on=docs",
              "_blank"
            )
          }
        >
